...
public class SurveyEditController {
    ...
    public SurveyEditController(SurveyService surveyService, QuestionService questionService) {
    ...
    public String editSurvey(@PathVariable Long id, Model model) {
        System.out.println("Получен запрос на редактирование анкеты с ID: " + id);
